...
document.getElementById("submit_caracter-creation").addEventListener("click", function (e) {
    ...
    arr['race'] = document.getElementById("raceSelect").options[document.getElementById("raceSelect").selectedIndex].value;
    arr['class'] = document.getElementById("classSelect").options[document.getElementById("classSelect").selectedIndex].value;
    ...
    // if(user_id !== "") {
    // client.post('/check-caracter-creation/'+user_id, jsoned, 'application/json', function (response) {

    // })


    client.post('/check-caracter-creation/'+USERID, jsoned, 'application/json', function (response) {

        document.location.href="/player/"+USERID;
    })
